...
#### Tasks:
- [ ] **Task 2.1.1: Background & Surface Hierarchy**
  ```dart
  ...
  ```
- [ ] **Task 2.1.2: Typography Color Tokens**
  ```dart
  ...
  ```
- [ ] **Task 2.1.3: 6 Selectable Accent Variants**
...
- [ ] **Task 2.1.4: Status & Priority Color Tokens**
...
#### Tasks:
- [ ] **Task 2.2.1: Inter & JetBrains Mono Typography Scale**
...
- [ ] **Task 2.2.2: Spacing Scale (`AuraSpacing`)**
  - `xs = 4.0`, `sm = 8.0`, `md = 12.0`, `lg = 16.0`, `xl = 20.0`, `xxl = 24.0`, `xxxl = 32.0`.
- [ ] **Task 2.2.3: Border Radii Scale (`AuraRadius`)**
