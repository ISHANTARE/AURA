...
#### Tasks:
- [ ] **Task 5.1.1: RateLimiter Class Implementation**
...
- [ ] **Task 5.1.2: RateLimiter Unit Tests**
...
#### Tasks:
- [ ] **Task 5.2.1: Provider Presets & System Prompt**
...
- [ ] **Task 5.2.2: JSON Extraction & Error Classification**
...
- [ ] **Task 5.2.3: LLM Client Unit Tests**
...
#### Tasks:
- [ ] **Task 5.3.1: 5 Core Regex Pattern Extractors**
...
#### Tasks:
- [ ] **Task 5.4.1: 4-Tier Workspace Taxonomy Engine**
...
- [ ] **Task 5.4.2: ExecuteAiActionUseCase Implementation**
...
- [ ] **Task 5.4.3: OfflineQueueProcessor Implementation**
