...
**Completed:**
- [x] VISION.md — why AURA exists
- [x] PRINCIPLES.md — 10 non-negotiable principles
- [x] CONTEXT.md — full project memory for AI tools
- [x] DECISIONS.md — 11 Architecture Decision Records
- [x] 01_Product/discovery.md — Phase 1 user research output
